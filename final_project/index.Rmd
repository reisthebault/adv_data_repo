...
An analysis of jail booking and release data, produced as the final project for an advanced data reporting class at UC Berkeley's Graduate School of Journalism. Data and code can be found here. 
